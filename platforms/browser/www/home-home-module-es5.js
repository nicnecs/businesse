...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _autocomplete_autocomplete_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ../autocomplete/autocomplete.page */
    "./src/app/autocomplete/autocomplete.page.ts");

    var HomePage = /*#__PURE__*/function () {
      function HomePage(http, nativeHttp, plt, loadingCtrl, navCtrl, modalController) {
      ...
      _createClass(HomePage, [{
        ...
        key: "getStandardData",
        value: function getStandardData() {
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    this.http.get('http://businesse.eastus.cloudapp.azure.com:8080/businesse/getHomeDataxampp.php').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                      return loading.dismiss();
                    })).subscribe(function (data) {
                      _this.data = data['_body'];
                      console.log(_this.data);
                      _this.json = JSON.parse(data['_body']);
                      console.log(_this.json);
                      console.log("On the Way");
                    }, function (err) {
                      console.log("Error", err); // console.log('Call error: ', err);
                    });
        ...
        value: function getData() {
          this.http.get('http://businesse.eastus.cloudapp.azure.com:8080/businesse/getHomeData.php').subscribe(function (data) {// this.json = data['_body'];
          }, function (success) {
            console.log("Success");
          });
        }
        ...
        key: "filterChanged",
        value: function filterChanged(ev) {
          console.log('Segment changed', ev);
        }
      }, {
        key: "toProject",
        value: function toProject(project_id) {
          this.id = project_id;
        }
      }, {
        key: "setCategory",
        value: function setCategory(name) {
          this.category = name;
          this.getStandardData();
        }
      }, {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    me = this; // modal.onDidDismiss(data => {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_3__["HTTP"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["NavController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["ModalController"]])], HomePage);
    /***/
  }
}]);
