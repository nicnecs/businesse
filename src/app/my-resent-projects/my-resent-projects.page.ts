...
@Component({
  selector: 'app-my-resent-projects',
  templateUrl: './my-resent-projects.page.html',
  styleUrls: ['./my-resent-projects.page.scss'],
})
export class MyResentProjectsPage implements OnInit {
